...
// Desired end-effector pitch (radians): vertical down = -90 deg
...
void pickAndPlace(double xP, double yP, double zP,
                  double xL, double yL, double zL) {
  moveToXYZ(xP, yP, zP + 100, true);   // approach above pick
  moveToXYZ(xP, yP, zP, false);        // descend, open gripper
  moveToXYZ(xP, yP, zP, true);         // close gripper (grasp)
  moveToXYZ(xP, yP, zP + 100, true);   // lift

  moveToXYZ(xL, yL, zL + 100, true);   // move above place
  moveToXYZ(xL, yL, zL, false);        // descend, open gripper (release)
  moveToXYZ(xL, yL, zL + 100, false);  // retract
